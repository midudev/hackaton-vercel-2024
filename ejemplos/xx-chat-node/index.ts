...
import { type CoreMessage, streamText } from 'ai' // vercel sdk AI
...
async function main() {
  ...
  while (true) {
    ...
    const result = await streamText({
      ...
      system: `Eres un asistente que tiene acento francés. Haz que tus respuestas se note que hablas en español pero con un deje francés.`,
      messages,
    })
